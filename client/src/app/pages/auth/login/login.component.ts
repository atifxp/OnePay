  ...
  template: `
    <div class="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div class="bg-white border border-gray-200 rounded-xl shadow-sm p-8 w-full max-w-sm">
        ...
        <p class="text-sm text-gray-500 mt-1 mb-6">Login to your OnePay account</p>
        ...
        <p class="text-sm text-gray-500 text-center mt-6">
          ...
          <a routerLink="/register" class="text-indigo-600 hover:underline font-medium">Register</a>
        </p>
